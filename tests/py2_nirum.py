...
class Offset(object):
    ...
    def __repr__(self):
        return '{0}({1!r})'.format(
            (type(self).__module__ + '.' + type(self).__name__), self.value
        )
...
class Shape(object):
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            ...
            "of it instead.".format((type(self).__module__ + '.' + type(self).__name__))
        )
...
class Location(object):
    ...
    @staticmethod
    def __nirum_field_types__():
        return {'name': typing.Optional[unicode],
        'lat': decimal.Decimal,
        'lng': decimal.Decimal}
...
class MusicService(service_type):
    ...
    __nirum_service_methods__ = {
        'get_music_by_artist_name': {
            '_v': 2,
            '_return': lambda: typing.Sequence[unicode],
            '_names': name_dict_type([('artist_name', 'artist_name')]),
            'artist_name': lambda: unicode
        },
'incorrect_return': {
            '_v': 2,
            '_return': lambda: unicode,
